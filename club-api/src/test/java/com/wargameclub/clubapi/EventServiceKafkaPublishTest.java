...
/**
 * Интеграционные тесты публикации Kafka-событий в сервисе мероприятий.
 */
@SpringBootTest
@ActiveProfiles("test")
public class EventServiceKafkaPublishTest {
    ...
    /**
     * Публикатор уведомлений (мок).
     */
    @MockBean
    private EventPublisher eventPublisher;

    /**
     * Сбрасывает моки перед каждым тестом.
     */
    @BeforeEach
    void resetMocks() {
    ...
    /**
     * Проверяет публикацию события покупки билета при регистрации.
     */
    @Test
    ...
    /**
     * Проверяет публикацию события отмены билета при отмене регистрации.
     */
    @Test
    ...
    /**
     * Проверяет публикацию события обновления мероприятия.
     */
    @Test
    ...
    /**
     * Создает и сохраняет тестовое мероприятие.
     *
